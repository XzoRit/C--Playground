========================================================================
    KONSOLENANWENDUNG: expl_templ_inst-Projektübersicht
========================================================================

Diese expl_templ_inst-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre expl_templ_inst-Anwendung besteht.


expl_templ_inst.vcxproj
...
expl_templ_inst.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "expl_templ_inst.pch und eine 
