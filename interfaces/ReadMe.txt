========================================================================
    KONSOLENANWENDUNG: interfaces-Projektübersicht
========================================================================

Diese interfaces-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die interfaces-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen interfaces.pch sowie eine vorkompilierte 
