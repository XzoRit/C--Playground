========================================================================
    KONSOLENANWENDUNG: ParamsOfSameType-Projektübersicht
========================================================================

Diese ParamsOfSameType-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die ParamsOfSameType-Anwendung besteht.


ParamsOfSameType.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen ParamsOfSameType.pch sowie eine vorkompilierte 
