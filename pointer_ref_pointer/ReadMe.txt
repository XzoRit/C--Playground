========================================================================
    KONSOLENANWENDUNG: pointer_ref_pointer-Projektübersicht
========================================================================

Diese pointer_ref_pointer-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die pointer_ref_pointer-Anwendung besteht.


pointer_ref_pointer.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen pointer_ref_pointer.pch sowie eine vorkompilierte 
