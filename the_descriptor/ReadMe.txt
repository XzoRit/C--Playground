========================================================================
    KONSOLENANWENDUNG: the_descriptor-Projektübersicht
========================================================================

Diese the_descriptor-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die the_descriptor-Anwendung besteht.


the_descriptor.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen the_descriptor.pch sowie eine vorkompilierte 
