========================================================================
    KONSOLENANWENDUNG: WrappingInclWithGuard-Projektübersicht
========================================================================

Diese WrappingInclWithGuard-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die WrappingInclWithGuard-Anwendung besteht.


WrappingInclWithGuard.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen WrappingInclWithGuard.pch sowie eine vorkompilierte 
