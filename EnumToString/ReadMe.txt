========================================================================
    KONSOLENANWENDUNG: EnumToString-Projektübersicht
========================================================================

Diese EnumToString-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die EnumToString-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen EnumToString.pch sowie eine vorkompilierte 
