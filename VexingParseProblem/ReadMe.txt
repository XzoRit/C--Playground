========================================================================
    KONSOLENANWENDUNG: VexingParseProblem-Projektübersicht
========================================================================

Diese VexingParseProblem-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die VexingParseProblem-Anwendung besteht.


VexingParseProblem.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen VexingParseProblem.pch sowie eine vorkompilierte 
