========================================================================
    KONSOLENANWENDUNG: ctorImprovements-Projektübersicht
========================================================================

Diese ctorImprovements-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre ctorImprovements-Anwendung besteht.


ctorImprovements.vcxproj
...
ctorImprovements.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ctorImprovements.pch und eine 
