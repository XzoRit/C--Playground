========================================================================
    KONSOLENANWENDUNG: ContPrettyPrint-Projektübersicht
========================================================================

Diese ContPrettyPrint-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre ContPrettyPrint-Anwendung besteht.


ContPrettyPrint.vcxproj
...
ContPrettyPrint.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ContPrettyPrint.pch und eine 
