========================================================================
    KONSOLENANWENDUNG: VirtualVsAbstract-Projektübersicht
========================================================================

Diese VirtualVsAbstract-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die VirtualVsAbstract-Anwendung besteht.


VirtualVsAbstract.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen VirtualVsAbstract.pch sowie eine vorkompilierte 
