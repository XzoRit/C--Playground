========================================================================
    KONSOLENANWENDUNG: ImplicitConversion-Projektübersicht
========================================================================

Diese ImplicitConversion-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die ImplicitConversion-Anwendung besteht.


ImplicitConversion.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen ImplicitConversion.pch sowie eine vorkompilierte 
